...
try {
	...
	switch ($_GET['view']) {
		case '':
			// page header
			page_header($system['system_title'].' - '.__("Explorer"));
			break;
		...
		case 'posts':
			...
			$params['url'] = $system['system_url'].'/explorer/'.'posts'.'/%s';
		...
		case 'users':
			...
			$params['total_items'] = $total->num_rows;
			$params['items_per_page'] = $system['max_results'];
			$params['url'] = $system['system_url'].'/explorer/'.'users'.'/%s';
			$pager = new Pager($params);
			$limit_query = $pager->getLimitSql();
		...
		case 'pages':
			...
			$params['total_items'] = $total->num_rows;
			$params['items_per_page'] = $system['max_results'];
			$params['url'] = $system['system_url'].'/explorer/'.'pages'.'/%s';
			$pager = new Pager($params);
			$limit_query = $pager->getLimitSql();
		...
		case 'events':
			...
			$params['total_items'] = $total->num_rows;
			$params['items_per_page'] = $system['max_results'];
			$params['url'] = $system['system_url'].'/explorer/'.'events'.'/%s';
			$pager = new Pager($params);
			$limit_query = $pager->getLimitSql();
		...
		case 'games':
			...
			$params['total_items'] = $total->num_rows;
			$params['items_per_page'] = $system['max_results'];
			$params['url'] = $system['system_url'].'/explorer/'.'games'.'/%s';
			$pager = new Pager($params);
			$limit_query = $pager->getLimitSql();
