            ...
            <div class="profile-header">
                        ...
                        {if $user->_data['user_id'] != $profile['user_id']}
                            ...
                            {elseif !$profile['friendship_declined']}
                                <button type="button" class="btn btn-sm btn-success js_friend-add" data-uid="{$profile['user_id']}">
                                    <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/addfr.png" class="mr5"> {__("Add Friend")}
                                </button>
                            {/if}
                             add friend -->
                            ...
                            <button type="button" class="btn btn-icon btn-rounded btn-primary mlr5 js_chat-start" data-uid="{$profile['user_id']}" data-name="{$profile['user_firstname']} {$profile['user_lastname']}" data-link="{$profile['user_name']}">
                                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/comm.png"> 
                            </button>
                            <!-- message -->
             ...
             <div class="profile-tabs-wrapper custom-scrollbar">
                    <ul>
                        ...
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/followers" {if $view == "followers" || $view == "followers" || $view == "followings"}class="active"{/if}>
                                  <img class="iconstable" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/group.svg" class="mr5"> {__("Members")}
                            </a>
                        </li>
                        <!--
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active"{/if}>
                                 <img class="iconstable" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/image.svg" class="mr5"> {__("Photos")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/videos" {if $view == "videos"}class="active"{/if}>
                                <img class="iconstable" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/video.svg" class="mr5">  {__("Videos")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/likes" {if $view == "likes"}class="active"{/if}>
                                <i class="fa fa-flag fa-fw mr5"></i>{__("Pages")} 
                            </a>
                        </li> -->
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/groups" {if $view == "groups"}class="active"{/if}>
                                <img class="iconstable" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/group.svg" class="mr5"> {__("Panels")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/events" {if $view == "events"}class="active"{/if}>
                                <img class="iconstable" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/event.svg" class="mr5">  {__("Events")}
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                ...
                {if $view == ""}
                    ...
                    <div class="order-2 col-lg-3 order-lg-3">
                        ...
                        {if $profile['photos']}
                            <div class="card panel-photos">
                                <div class="card-header bg-transparent">
                                 <img class="iconstable" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/image.svg" class="mr5">
                        ...
                        {if $profile['followers_count'] > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    ...
                                    <strong><a href="{$system['system_url']}/{$profile['user_name']}/followers">{__("Participants")}</a></strong>
                                    <span class="badge badge-pill badge-info ml5">{$profile['followers_count']}</span> 
                                    
                                </div>
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                                        {foreach $profile['followers'] as $_friend}
                        ...
                        {if count($profile['pages']) > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    ...
                                    <strong><a href="{$system['system_url']}/{$profile['user_name']}/likes">{__("Pages")}</a></strong>
                                </div>
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                       ...
                       pages -->
                        ...
                        {if count($profile['groups']) > 0}
                            <div class="card">
                                <div class="card-header bg-transparent">
                                    <i class="fa fa-users mr5"></i>
                                    <strong><a href="{$system['system_url']}/{$profile['user_name']}/groups">{__("Panels")}</a></strong>
                                </div>
                                <div class="card-body ptb10 plr10">
                                    <div class="row no-gutters">
                    ...
                    <div class="order-3 col-lg-6 order-lg-2">
                        <!-- publisher -->
                        {if $user->_logged_in && $user->_data['user_group'] < 3}
                            {if $user->_data['user_id'] == $profile['user_id']}
                            ...
                            <div class="card-header with-icon with-nav">
                                ...
                                <ul class="nav nav-tabs">
                                   <!--  <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{$system['system_url']}/{$profile['user_name']}/followers">{__("Participants")}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{$system['system_url']}/{$profile['user_name']}/followings">{__("Specialists")}</a>
                                    </li>
                                </ul>
                                <!-- panel nav -->
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body pb0">
                                ...
                                {else}
                                    <p class="text-center text-muted mt10">
                                        {$profile['user_firstname']} {__("doesn't have Participants")}
                                    </p>
                                {/if}
                            </div>
                        </div>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{$system['system_url']}/{$profile['user_name']}/followers">
                                            <strong class="pr5">{__("Participants")}</strong>
                                            <span class="badge badge-pill badge-info">{$profile['followers_count']}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header with-icon">
                                ...
                                <i class="fa fa-thumbs-up mr10"></i>{__("Pages")}
                ...
                {elseif $view == "groups"}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header with-icon">
                                <!-- panel title -->
                                <i class="fa fa-users mr10"></i>{__("Panels")}
                                <!-- panel title -->
                            </div>
                            <div class="card-body">
