                    ...
                    <ul>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}" {if $view == ""}class="active"{/if}>
                               ...
                               <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/timel.png" class="mr5">{__("Timeline")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/friends" {if $view == "friends" || $view == "followers" || $view == "followings"}class="active"{/if}>
                                  <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/membb.png" class="mr5"> {__("Members")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active"{/if}>
                                 <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/tof.png" class="mr5"> {__("Photos")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/videos" {if $view == "videos"}class="active"{/if}>
                                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/video.png" class="mr5">  {__("Videos")}
                            </a>
                        </li>
                        <!--<li>
                        ...
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/groups" {if $view == "groups"}class="active"{/if}>
                                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/membb.png" class="mr5"> {__("Panels")}
                            </a>
                        </li>
                        <li>
                            <a href="{$system['system_url']}/{$profile['user_name']}/events" {if $view == "events"}class="active"{/if}>
                                <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/eventt.png" class="mr5">  {__("Events")}
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="order-2 col-lg-3 order-lg-3">
                        ...
                        {if $profile['photos']}
                            <div class="card panel-photos">
                                <div class="card-header bg-transparent">
                                 <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/tof.png" class="mr5">
