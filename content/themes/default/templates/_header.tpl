                                            ...
                                            {if $user->_logged_in}
                                                ...
                                                <li class="d-block d-md-none">
                                                    <a href="#" data-toggle="offcanvas">
                                                         <img class="iconspostsearch" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/menu.png"> 
                                                    </a>
                                                </li>
                                                <!-- bars -->
    
                                               <!-- updateiconsHomeAynet -->
                                                <!-- home -->
                                                <li class="iconsHomeAynet">
                                                    <a href="{$system['system_url']}">
                                                        <img src="{$system['system_url']}/content/themes/default/images/icons/home.svg" class="iconspostsearch">
                                                    </a>
                                                </li>
                                                <!-- home -->
                                                 <!-- updateiconsHomeAynet -->
                                                ...
                                                <li class="d-block d-md-none">
                                                    <a href="{$system['system_url']}/search">
                                                        <img class="iconspostsearch" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/searchbl.svg"> 
                                                    </a>
                                                </li>
                                                <li class="iconsHomeAynet">
                                                    <a >
                                                    <span class="text-link" data-toggle="modal" data-url="#translator">
                                                        {if $system['language']['title']=='English'}
                                                          <img class="iconspostsearch" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/lang.png"> 
                                                        {else}
                                                        <img class="iconspostsearch" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/lang.png">
                                                        {/if}
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        {/if}
                                                        <!--<a class="dropdown-item" href="{$system['system_url']}/{$user->_data['user_name']}"><img class="iconspetit" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/newsbl.svg"> {__("Profile")}</a>-->
                                                        ...
                                                        {/if}
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="{$system['system_url']}/signout"> <img class="iconspetit" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/signout.svg"> {__("Log Out")}</a>
                                                        <div class="dropdown-divider"></div>
                                                            ...
                                                            {if $system['theme_mode_night']}
                                                                <div class="dropdown-item pointer js_theme-mode" data-mode="day">
                                                                    ...
                                                                    <span class="float-right">
                                                                        ...
                                                                        <div class="js_theme-mode-icon sunaaynet"></div>
                                                                    </span>
                                                                </div>
                                                            {else}
                                                                <div class="dropdown-item pointer js_theme-mode" data-mode="night">
                                                                    ...
                                                                    <span class="float-right">
                                                                       ...
                                                                       <div  class="js_theme-mode-icon moonaaynet"></div >
                                                                    </span>
                                                                </div>
                                                            {/if}
                                                        {/if}
                                            ...
                                            {else}
                                                ...
                                                <li class="dropdown float-right">
                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-display="static">
                                                        <span>{__("Join Us")}</span>
                                                    </a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="{$system['system_url']}/signin">  <img class="iconspetit" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/login.svg"> {__("Login")}</a>
                                                        {if $system['registration_enabled'] || (!$system['registration_enabled'] && $system['invitation_enabled'])}
                                                            <a class="dropdown-item" href="{$system['system_url']}/signup"> <img class="iconspetit" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/signup.svg"> {__("Register")}</a>
                                                        {/if}
                                                        <div class="dropdown-divider"></div>
                                                        {if $system['system_theme_mode_select']}
                                                            {if $system['theme_mode_night']}
