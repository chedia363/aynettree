            ...
            <div class="card-body">
                <div class="form-group form-row">
                    ...
                    <label class="col-md-3 form-control-label">
                     ...
                     <div class="col-md-9">
                        <input class="form-control" name="category_nameAr">
                    </div>
                </div>
    ...
    {elseif $sub_view == "edit_category"}
        ...
        <form class="js_ajax-forms " data-url="admin/groups.php?do=edit_category&id={$data['category_id']}">
            <div class="card-body">
				 ...
				 <label class="col-md-3 form-control-label">
                  ...
                  <br/><br/><br/><br/>
                    <label class="col-md-3 form-control-label">
                     ...
                     <div class="col-md-9">
                        <input class="form-control" name="category_nameAr" value="{$data['category_nameAr']}">
                    </div>
               ...
               <!-- {if $system['language']['code']=="ar_sa"}
                 ...
                 <label class="col-md-3 form-control-label">
                   ...
                   <div class="col-md-9">
                        <input class="form-control" name="category_name" value="{$data['category_name']}" type="hidden">
                    </div>
			...
			{elseif $system['language']['code']=="en_us"}
                   ...
                   <div class="col-md-9">
                        <input class="form-control" name="category_nameAr" value="{$data['category_nameAr']}" type="hidden">
                    </div>
