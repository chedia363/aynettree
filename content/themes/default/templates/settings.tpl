                ...
                <div class="card-body with-nav">
                    <ul class="side-nav">
                            ...
                            {if $system['facebook_login_enabled'] || $system['twitter_login_enabled'] || $system['google_login_enabled'] || $system['instagram_login_enabled'] || $system['linkedin_login_enabled'] || $system['vkontakte_login_enabled']}
                                <li {if $view == "linked"}class="active"{/if}>
                                    <a href="{$system['system_url']}/settings/linked">
                                       <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/iconverf.svg"> {__("Linked Accounts")}
                                    </a>
                                </li>
                            {/if}
                        {/if}
                        {if $system['packages_enabled']}
                            <li {if $view == "membership"}class="active"{/if}>
                                <a href="{$system['system_url']}/settings/membership">
                                    <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/iconverf.svg"> {__("Membership")}
                                </a>
                            </li>
                        {/if}
                        ...
                        {if $system['download_info_enabled']}
                         ...
                         <img class="iconspost" src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/information.svg"> {__("Your Information")}
                                </a>
                            </li>
                        {/if}
                ...
                {elseif $view == "security"}
                    {if $sub_view == "password"}
                        ...
                        <form class="js_ajax-forms " data-url="users/settings.php?edit=password">
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="form-control-label">{__("insert Current Password")}</label>
                    ...
                    <form class="js_ajax-forms " data-url="users/settings.php?edit=notifications">
                        <div class="card-body">
                            ...
                            <div class="pl-md-4">
                                <div class="form-table-row">
                                    <div>
                                        <div class="form-control-label h6">{__("Sound notification of message")}</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <label class="button-label" for="download_followings">
                                    ...
                                    <div class="title">{__("Your Followings")}</div>
                                </label>
                                <!-- Followings -->
                                <!-- Followers -->
                                ...
                                <label class="button-label" for="download_followers">
                                    ...
                                    <div class="title">{__("Your Followers")}</div>
                                </label>
                                <!-- Followers -->
                            </div>
                            <div class="text-center">
