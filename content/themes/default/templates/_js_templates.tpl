{strip}
<!-- Modals -->
<script id="create-group-in" type="text/template">
            <div class="modal-header">
                <h6 class="modal-title">{__("Create New panel")}</h6>
            ...
            <form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=group&do=create">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input  hidden type="number" class="form-control" name="category" id="category" value="{$group["group_category"]}"> 
    ...
    {if $system['daytime_msg_enabled'] && $page == "index"}
        <script id="message-morning" type="text/template">
            <div class="card daytime_message">
              ...
              <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/good_morning.png"> 
                <strong>{$system['morning_title']}</strong>
            </div>
        </script>
        ...
        <script id="message-afternoon" type="text/template">
            <div class="card daytime_message">
                ...
                <strong>{$system['afternoon_title']}</strong>
            </div>
        </script>
        ...
        <script id="message-evening" type="text/template">
            <div class="card daytime_message">
                ...
                <strong>{$system['evening_title']}</strong>
            </div>
        </script>
    {/if}
    <!-- DayTime Messages -->
