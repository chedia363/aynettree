            ...
            <div class="tab-pane" id="Features">
                <form class="js_ajax-forms " data-url="admin/settings.php?edit=features_settings">
                    <div class="card-body">
                        ...
                        <div class="form-table-row">
                            <div>
                                <div class="form-control-label h6">{__("Panels")}</div>
                       ...
                       <div class="form-table-row">
                            ...
                            <div class="text-right">
                               <!-- <label class="switch" for="daytime_msg_enabled">
                                ...
                                <label>
                                    <textarea class="form-control" name="morning_title" rows="3">{$system['morning_title']}</textarea>

                                   <span class="form-text">
                                       {__("write morning vibes")}
                                   </span>
                                ...
                                <label>
                                    <textarea class="form-control" name="afternoon_title" rows="3">{$system['afternoon_title']}</textarea>
                                  
                                   <span class="form-text">
                                       {__("write Afternoon vibes")}
                                   </span>
                                ...
                                <label>
                                   <textarea class="form-control" name="evening_title" rows="3">{$system['evening_title']}</textarea>

                                   <span class="form-text">
                                       {__("write Evening vibes")}
                                   </span>
