                ...
                <div class="col-lg-8">
                    ...
                    <ul class="nav nav-pills nav-fill nav-search mb10">
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded-pill" href="#groups" data-toggle="tab">
                                <i class="fa fa-users mr5"></i><strong>{__("Panels")}</strong>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded-pill" href="#all" data-toggle="tab">
                                <i class="fa fa-list-ul mr5"></i><strong>{__("All")}</strong>
                            </a>
                        </li>
                    </ul>
                    <!-- panel nav -->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="all">
                            {if (count($results['pages']) > 0) || (count($results['users']) > 0) || (count($results['posts']) > 0) || (count($results['groups']) > 0) || (count($results['articles']) > 0) || (count($results['events']) > 0)}
                                    <ul>
                                        {foreach $results['users'] as $_user}
                                        {include file='__feeds_user.tpl' _tpl="list" _connection=$_user['connection']}
                                        {/foreach}
