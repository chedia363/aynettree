	...
	switch ($_GET['edit']) {
		...
		case 'features_settings':
			...
			$db->query(sprintf("UPDATE system_options SET 
						...
						afternoon_title = %s, 
						evening_title = %s, 
						adblock_detector_enabled = %s ", secure($_POST['contact_enabled']), secure($_POST['directory_enabled']), secure($_POST['pages_enabled']), secure($_POST['groups_enabled']), secure($_POST['events_enabled']), secure($_POST['blogs_enabled']), secure($_POST['users_blogs_enabled']), secure($_POST['market_enabled']), secure($_POST['movies_enabled']), secure($_POST['games_enabled']), secure($_POST['pokes_enabled']), secure($_POST['gifts_enabled']), secure($_POST['profile_notification_enabled']), secure($_POST['browser_notifications_enabled']), secure($_POST['noty_notifications_enabled']), secure($_POST['cookie_consent_enabled']), secure($_POST['morning_title']), secure($_POST['afternoon_title']), secure($_POST['evening_title']), secure($_POST['adblock_detector_enabled']) )) or _error("SQL_ERROR_THROWEN");
			break;
