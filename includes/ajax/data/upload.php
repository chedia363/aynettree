...
try {
    switch ($_POST["type"]) {
                ...
                foreach ($files as $file) {
                    ...
                    if(!isset($file) || $file["error"] != UPLOAD_ERR_OK) {
                        if($files_num > 1) {
                            ...
                            modal("MESSAGE", __("Upload Error"), __("the upload reaches maximum size"));
                        }
                    }
        ...
        case 'file':
            ...
            //     $file_name = $directory.$prefix.'chedia';
            //  } else {
                
            //  }
            // sol2***not secured for the files 
            // $file_name = $directory.mt_rand().$prefix;
            $file_name = $directory.get_hash_token().$prefix;
